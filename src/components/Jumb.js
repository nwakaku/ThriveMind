...
export const Jumb = () => {
  return (
      ...
      <section class="bg-center bg-no-repeat bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/conference.jpg')] bg-gray-700 bg-blend-multiply">      
        ...
        <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-200"> Ignite your brilliance and transform relationships with our daily micro-wellness challenges, blending ACT principles for effortless self-awareness, guiding you toward a life of flourishing wellness and connection</p>
        <form class="w-full max-w-md mx-auto">   
            <label htmlFor="default-email" class="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white"> sign-up</label>
            <div class="relative">
                ...
                <button type="submit" class="text-white absolute end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Sign In</button>
            </div>
        </form>
    </div>

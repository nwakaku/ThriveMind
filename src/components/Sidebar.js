      ...
      <div class="flex antialiased h-screen pb-12 w-full text-gray-800">
        <div class="flex flex-row h-full w-full overflow-x-hidden">
          ...
          <div class="flex flex-col py-4 pl-4 pr-4 w-64 bg-white flex-shrink-0 my-6 rounded-xl">
            <div className="flex justify-center bg-gray-300 p-4 rounded-md">
              <h3>Journals</h3>
            </div>
              ...
              <ul class="space-y-4 font-medium">
                {journal.map((item, index) => (
                  <li key={index}>
                    <a
                      href="#"
                      className="flex justify-around items-center py-4 text-gray-900 rounded-lg dark:text-white dark:bg-gray-700 group">
                      <div
